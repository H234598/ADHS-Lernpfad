---
title: "Lernstörungen, Sprachentwicklungsstörungen und intellektuelle Beeinträchtigung bei ADHS"
level: Vertiefung
...
```mermaid
flowchart TD
  P[auffällige Leistung oder Lernproblem] --> A[ADHS-bezogene Steuerung prüfen]
  P --> L[spezifische schulische Fertigkeiten prüfen]
  P --> S[Sprachentwicklung und Sprachprofil prüfen]
  P --> I[allgemeine intellektuelle und adaptive Funktionen prüfen]
  A --> K[klinische Gesamtformulierung]
  L --> K
  S --> K
  I --> K
  K --> Z[getrennte Unterstützungsziele]
```
