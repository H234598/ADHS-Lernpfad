...
tags: [ADHS, Angststörungen, Komorbidität, Differentialdiagnostik, Vermeidung, Lebensspanne]
last_reviewed: 2026-07-30
evidence: high
status: consensus
references: [Faraone2021, NICE2018, AADPA2022, Hoskins2026, Njardvik2025, Zhang2025]
...
```mermaid
flowchart TD
  A[ADHS-bezogene Regulationsschwierigkeit] --> B[Fehler, Konflikt oder Unsicherheit]
  B --> C[Bedrohungserwartung und Sorgen]
  C --> D[Vermeidung oder Sicherheitsverhalten]
  D --> E[Aufgabenstau und weniger korrigierende Erfahrung]
  E --> B
  C -. bindet .-> F[Aufmerksamkeit und Arbeitsgedächtnis]
  F -. erschwert .-> A
  S[Unterstützung, Behandlung und klare Umwelt] --> A
  S --> C
  S --> D
```
