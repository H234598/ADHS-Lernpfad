---
title: "Zwangssymptome, Zwangsstörung und ADHS: Funktion, Abgrenzung und Koexistenz"
level: Vertiefung
estimated_time: 10–20 min
difficulty: 3
prerequisites:
  - 01-Grundlagen/02-Inhibition-und-Handlungssteuerung
  - 01-Grundlagen/07-Emotionsregulation
  - 01-Grundlagen/09-Diagnostische-Kriterien-und-Differentialdiagnostik
  - 02-Vertiefung/01-Pharmakologie-und-Psychotherapie
  - 02-Vertiefung/04-Angststoerungen-und-ADHS
tags: [ADHS, Zwangsstörung, Zwangsgedanken, Zwangshandlungen, Differentialdiagnostik, Komorbidität]
last_reviewed: 2026-07-31
evidence: high
status: consensus
references: [Faraone2021, NICE2018, AADPA2022, Abramovitch2015, Voderholzer2022, SerranoOrtiz2026]
...
```mermaid
flowchart TD
  A[Aufdringlicher Gedanke oder Zweifel] --> B[Bedrohungsbewertung und Unsicherheit]
  B --> C[Zwangshandlung, mentales Ritual oder Rückversicherung]
  C --> D[kurzfristige Erleichterung]
  D --> E[weniger Gelegenheit, Unsicherheit ohne Ritual auszuhalten]
  E --> A
  S[Exposition mit Reaktionsmanagement] -. unterbricht .-> C
  U[ADHS-gerechte Struktur und Erinnerung] -. reduziert reale Organisationsfehler .-> B
```
