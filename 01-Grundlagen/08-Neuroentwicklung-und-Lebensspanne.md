---
title: Neuroentwicklung und Lebensspanne
level: Grundlagen
estimated_time: 10–20 min
difficulty: 2
prerequisites: ["Was ist ADHS?", "Emotionsregulation"]
tags: [ADHS, Neuroentwicklung, Lebensspanne, Persistenz, Remission]
last_reviewed: 2026-07-14
evidence: high
status: consensus
references: [Faraone2021, Sibley2022, Sibley2018]
...
```mermaid
flowchart TD
  K[ADHS-Merkmale in der Kindheit] --> V[weiterer Verlauf]
  A[Anforderungen] --> V
  U[Unterstützung und Behandlung] --> V
  S[Schlaf, Stress und Komorbiditäten] --> V
  L[Lernen und Kompensation] --> V
  V --> P[anhaltende Beeinträchtigung]
  V --> T[Teilremission]
  V --> R[zeitweise Remission]
  R --> W[mögliche Wiederkehr bei neuer Belastung]
```
