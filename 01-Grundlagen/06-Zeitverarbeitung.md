...
```mermaid
flowchart TD
  Z[Ziel aktiv halten] --> H[rechtzeitige Handlung]
  D[Dauer schätzen] --> H
  U[Zeit überwachen] --> H
  I[Ablenkung hemmen] --> H
  W[Tätigkeit wechseln] --> H
  M[Zukunft ausreichend gewichten] --> H
```
