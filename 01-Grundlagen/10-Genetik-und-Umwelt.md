---
title: Genetik und Umwelt
level: Grundlagen
estimated_time: 10–20 min
difficulty: 2
prerequisites: ["Was ist ADHS?", "Neuroentwicklung und Lebensspanne", "Diagnostische Kriterien und Differentialdiagnostik"]
tags: [ADHS, Genetik, Umwelt, Heritabilität, Polygenität]
last_reviewed: 2026-07-16
evidence: high
status: consensus
references: [Demontis2023, Nikolas2010, Thapar2013, Faraone2021]
...
```mermaid
flowchart LR
  G[viele genetische Varianten\nmit kleinen Effekten] --> R[statistische Anfälligkeit]
  U[nichtgenetische Einflüsse\nund Entwicklungsbedingungen] --> R
  Z[Zufall, Messfehler und\nindividuelle Entwicklung] --> R
  R --> P[heterogenes Merkmalsprofil]
  P --> K[Kontext und Anforderungen]
  K --> B[unterschiedliche Beeinträchtigung]
  H[Unterstützung und Behandlung] --> B
```
