...
tags: [ADHS, Depression, Suizidalität, Komorbidität, Krisenprävention]
last_reviewed: 2026-07-21
evidence: high
status: consensus
references: [Garas2025, Rother2025, Zhang2025, vanDerPlas2026, AADPA2022, Faraone2021]
...
```mermaid
flowchart TD
  A[ADHS-bezogene Beeinträchtigung] --> B[Konflikte, Misserfolge oder Überforderung]
  C[biologische und familiäre Einflüsse] --> D[depressive Vulnerabilität]
  E[Schlaf, Trauma, Substanzen und soziale Belastung] --> D
  B --> D
  D --> F[Rückzug, Hoffnungslosigkeit und geringerer Antrieb]
  F --> G[mehr Alltagsprobleme]
  G --> B
  D --> H[Suizidgedanken können auftreten]
  I[Behandlung, Sicherheit, Beziehungen und praktische Unterstützung] --> B
  I --> D
  I --> H
```
