...
difficulty: 2
prerequisites: [Inhibition und Handlungssteuerung, Arbeitsgedächtnis]
tags: [ADHS, Emotionsregulation, Impulsivität]
last_reviewed: 2026-07-13
evidence: high
status: consensus
references: [Beheshti2020]
...
flowchart LR
  A[Auslöser] --> G[Gefühl]
  G --> I[Impuls]
  I --> P[Pause und Benennung]
  P --> H[sichere Handlung]
  G -. bindet .-> W[Arbeitsgedächtnis]
  G -. verändert .-> E[Aufmerksamkeit]
```
