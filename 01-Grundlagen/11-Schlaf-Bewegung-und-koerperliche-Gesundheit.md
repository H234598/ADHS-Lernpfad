---
title: Schlaf, Bewegung und körperliche Gesundheit
level: Grundlagen
estimated_time: 10–20 min
difficulty: 2
prerequisites: ["01-Grundlagen/01-Was-ist-ADHS", "01-Grundlagen/09-Diagnostische-Kriterien-und-Differentialdiagnostik", "01-Grundlagen/10-Genetik-und-Umwelt"]
tags: [ADHS, Schlaf, Bewegung, körperliche Gesundheit, Komorbidität]
last_reviewed: 2026-07-17
evidence: high
status: consensus
references: [AADPA2022, Cortese2024, Liang2023, Sun2024, Faraone2021]
...
```mermaid
flowchart TD
  A[ADHS-bezogene Steuerungsprobleme] --> B[unregelmäßige Abendroutine]
  B --> C[später oder verkürzter Schlaf]
  C --> D[mehr Tagesmüdigkeit]
  D --> E[schwächere Aufmerksamkeit und Emotionsregulation]
  E --> A
  F[Schlafstörung oder körperliche Erkrankung] --> C
  G[passende Abklärung und Unterstützung] --> H[Unterbrechung des Kreislaufs]
  H --> B
  H --> D
```
