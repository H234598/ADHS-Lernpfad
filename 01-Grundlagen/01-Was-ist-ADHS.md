...
difficulty: 1
prerequisites: []
tags: [ADHS, Neuroentwicklung, Exekutive-Funktionen]
last_reviewed: 2026-07-13
evidence: high
status: consensus
references: [Faraone2021]
...
```mermaid
flowchart LR
  A[Anforderung] --> B[Aufmerksamkeit]
  B --> C[Arbeitsgedächtnis]
  C --> D[Inhibition]
  D --> E[zielgerichtete Handlung]
  M[Motivation und Kontext] --> B
  M --> E
  T[Zeit und Emotion] --> C
  T --> E
```
