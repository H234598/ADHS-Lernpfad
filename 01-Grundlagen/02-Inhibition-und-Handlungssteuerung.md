---
title: Inhibition und Handlungssteuerung
level: Grundlagen
...
```mermaid
flowchart TD
  R[Reiz] --> I{Impuls sofort ausführen?}
  I -->|kurze Pause| Z[Ziel reaktivieren]
  Z --> W[Konsequenzen abwägen]
  W --> H[passende Handlung]
  I -->|keine Pause| A[automatische Reaktion]
```
