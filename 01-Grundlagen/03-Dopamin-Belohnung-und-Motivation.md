---
title: Dopamin, Belohnung und Motivation
level: Grundlagen
estimated_time: 10–20 min
difficulty: 2
prerequisites: [Inhibition und Handlungssteuerung]
tags: [ADHS, Dopamin, Motivation, Belohnung]
last_reviewed: 2026-07-13
evidence: high
status: consensus
references: [Volkow2011]
...
```mermaid
flowchart LR
  A[Aufgabe] --> B{Rückmeldung jetzt?}
  B -->|ja| C[starkes Handlungssignal]
  B -->|später| D[Abwertung durch Verzögerung]
  D --> E[Start und Durchhalten schwieriger]
  F[Interesse / Neuheit / Zeitdruck] --> C
```
